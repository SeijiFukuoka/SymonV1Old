...
class SignActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        email.typeface = regulartTypeface

        val boldTypeface = Typeface.createFromAsset(assets,
                String.format(Locale.US, "fonts/%s", "Montserrat-Bold.ttf"))
        email_cadastro.typeface = boldTypeface
        new_user.typeface = boldTypeface

        val mediumTypeface = Typeface.createFromAsset(assets,
                String.format(Locale.US, "fonts/%s", "Montserrat-Medium.ttf"))
        email_sign_in_button.setAllCaps(false)
        email_sign_in_button.typeface = mediumTypeface
        email_sign_in_button.setShadowLayer(0.01f, -2.toFloat(), 2.toFloat(), getResources().getColor(R.color.blackAlpha));
        email_sign_in_button.setOnClickListener { attemptLogin() }

        register_now.setAllCaps(false)
        register_now.typeface = mediumTypeface
        register_now.setShadowLayer(0.01f, -2.toFloat(), 2.toFloat(), getResources().getColor(R.color.blackAlpha));
